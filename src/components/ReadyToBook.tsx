  ...
  return (
    <>
      <style>{`
        ...
        .rtb-glow {
          position: absolute; inset: 0;
          background: radial-gradient(ellipse 90% 120% at 50% 40%, rgba(0,196,106,0.11) 0%, transparent 65%);
          pointer-events: none;
        }
        ...
        .rtb-dots {
          position: absolute; inset: 0;
          background-image: 
            radial-gradient(circle at 10px 10px, rgba(0,196,106,0.06) 1.5px, transparent 1.5px);
        ...
        .rtb-eyebrow-dot {
          ...
          box-shadow: 0 0 12px rgba(0,196,106,0.6);
          animation: pulse 2.4s ease-in-out infinite;
        }

        @keyframes pulse {
          0%, 100% { box-shadow: 0 0 8px rgba(0,196,106,0.4); }
          50%      { box-shadow: 0 0 20px rgba(0,196,106,0.9); }
        }
        ...
        .rtb-btn-primary {
          background: var(--emerald);
          color: black;
          box-shadow: 0 8px 32px rgba(0,196,106,0.35);
        }

        .rtb-btn-primary:hover {
          background: var(--emerald-dark);
          transform: translateY(-3px);
          box-shadow: 0 16px 48px rgba(0,196,106,0.5);
        }
        ...
        @media (max-width: 768px) {
          ...
          .rtb-stat { border-right: none; border-bottom: 1px solid rgba(255,255,255,0.06); }
        ...
        <div className="rtb-inner">
          ...
          <div className="rtb-ctas animate-fadeup" style={{ animationDelay: "0.65s" }}>
            ...
            <a
              ...
              className="rtb-btn rtb-btn-secondary"
            >
